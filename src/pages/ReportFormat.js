...
const ReportFormat = () => {
  return (
    <>
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <form action="/delete_formate" method="post">
              <input
              ...
              <div className="modal-header justify-content-center border-0">
                <h1 className="modal-title fs-5" id="exampleModalToggleLabel">
                  Do you want to delete formate for "
      ...
      <div className="add-new-report dashboard">
        <div className="report-body admin">
          <h2 className="profile-heading">Report Formats</h2>
          ...
          <div className="d-flex justify-content-end img-ctrl-btn align-items-center mb-3">
            <Link to="/new-report-prepare" className="btn plus add-more-btn">
              <svg
          ...
          >
            <thead className="">
              <tr>
                <th className="">
                  <span className="">Formate ID</span>
                </th>
                <th className="">
                  <span className="">Formate Name</span>
                </th>
                <th className="">
                  <span className="">Formate Type</span>
                </th>
                <th className="">
